        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomInt1Enabled = table.Column<bool>(type: "boolean", nullable: false),
                    CustomInt1Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    CustomInt2Enabled = table.Column<bool>(type: "boolean", nullable: false),
                    CustomInt2Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    CustomInt3Enabled = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomLink1Value = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CustomLink2Value = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CustomLink3Value = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaddingLength = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomIdElements_CustomIdFormatId_SortOrder",
                table: "CustomIdElements",
                columns: new[] { "CustomIdFormatId", "SortOrder" });
